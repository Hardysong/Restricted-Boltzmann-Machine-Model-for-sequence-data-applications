function [rbm,bp_info] = rbm_partiallysupervisedtrain(rbm,x,y,opts)
% --------------------------------------------------------------------------
%   Used by Gaussian-Bernoulli RBM and Bernoulli-Bernoulli RBM. 
%   Partially Supervised Train for Regression Problem
%
%   The different with crbm_partiallysupervisedtrain is the activation
%   function that crbm have more parameter to study (A the slop of sigmoid)
%
...
%   supervised training process could force the weight between vis and hid
...
dAct = calcActDerive(bp_info.act{2},'sigmoid');
