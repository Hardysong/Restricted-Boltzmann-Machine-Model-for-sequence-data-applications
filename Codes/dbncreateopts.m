...
opts.partially_supervised_normGrad = 0; % for regression, whether norm the gradient.
opts.partially_supervised_maxNorm = Inf; % for regression problem. renormalize weights whose nor exceed maxNorm.
